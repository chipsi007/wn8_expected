...
#####################################
    jpegString <- paste("plots2/", names(model$model)[1],"_vs_",names(model$model)[2], "_v31_%i_%s.jpg")
...
savedPlot <- paste("plots2/",names(usermodel$model)[1],"vs", names(usermodel$model)[2],"_v31.jpg")
ggsave(file=savedPlot, width=7, height=7)
